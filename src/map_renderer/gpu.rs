...
pub fn apply_gpu_post_process(image: &RgbImage) -> Result<RgbImage, String> {
    ...
    let processed = pollster::block_on(process_rgba_gpu(width, height, pixels))?;
...
#[cfg(feature = "gpu")]
async fn process_rgba_gpu(width: u32, height: u32, input: Vec<u8>) -> Result<Vec<u8>, String> {
